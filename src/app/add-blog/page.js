        ...
        <div className="flex min-h-screen flex-col p-8">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-3">
                    ...
                    <input className="border border-red-500 p-3 outline-none"
                        name="title"
                        placeholder="Emter blog titel"
                        value={blogFormData['titel']}
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <textarea rows={5} className="border border-red-500 p-3 outline-none"
                        name="description"
